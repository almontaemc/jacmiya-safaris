...
const destinations = [
  {
    ...
    description:
      "Kenya is where the safari was born. From the iconic Masai Mara — where the Great Migration thunders across the Mara River — to the snow-capped peaks of Mount Kenya and the white sands of Diani Beach, this is a country of jaw-dropping contrasts.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "Tanzania is home to the Serengeti — arguably the world's greatest wildlife spectacle. Add the Ngorongoro Crater (the world's largest inactive caldera), Tarangire's baobab forests, and the paradise island of Zanzibar, and you have a destination that rivals anywhere on earth.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "Rwanda is Africa's most extraordinary comeback story — a country that has transformed itself into one of the continent's cleanest, safest, and most remarkable destinations. The star attraction? Trekking through mist-shrouded volcanic forests to encounter mountain gorillas face to face.",
    highlights: [
  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <p className="text-cream/70 text-lg max-w-xl mx-auto leading-relaxed">
            Three extraordinary countries. Infinite wild encounters. One
            company that knows every corner of them.
          </p>
        </div>
      </section>
      ...
      {destinations.map((dest, index) => (
        <section
          key={dest.country}
          className={`py-24 px-4 ${index % 2 === 0 ? "bg-cream" : "bg-sand"}`}
        >
          <div className="max-w-7xl mx-auto">
            {/* Header card */}
            <div
              className={`relative rounded-2xl overflow-hidden mb-12 ${index % 2 === 1 ? "lg:flex-row-reverse" : ""}`}
            >
              <div className="relative h-72 sm:h-96">
                ...
                <div className="absolute inset-0 flex items-center px-10">
                  <div>
                    <div className="text-savanna text-xs font-semibold uppercase tracking-widest mb-2">
                      Destination
                    </div>
                    <h2 className="font-serif text-4xl sm:text-5xl font-bold text-cream mb-2">
                      {dest.country}
                    </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
              ...
              <div className="lg:col-span-1">
                ...
                <div className="bg-white rounded-xl p-5 border border-sand mb-4">
                  <h4 className="text-bark font-semibold text-xs uppercase tracking-wider mb-2">
                    Best Time to Visit
                  </h4>
                ...
                <div className="bg-forest/10 rounded-xl p-5 border border-forest/20">
                  <h4 className="text-forest font-semibold text-xs uppercase tracking-wider mb-2">
                    💡 Pro Tip
                  </h4>
              ...
              <div className="lg:col-span-2">
                <h3 className="font-serif text-xl font-bold text-bark mb-6">
                  Top Highlights in {dest.country}
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {dest.highlights.map((h) => (
                    <div
                      key={h.name}
                      className="bg-white rounded-xl p-5 border border-sand hover:border-savanna/40 transition-colors"
                    >
                ...
                <div className="mt-6 flex gap-3">
                  ...
                  <Link
                    href="/contact"
                    className="border border-forest text-forest hover:bg-forest hover:text-cream font-semibold px-6 py-2.5 rounded-full text-sm transition-colors"
                  >
                    Ask an Expert
                  </Link>
                </div>
      ...
      <section className="py-20 px-4 bg-forest text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-cream/60 mb-8 text-lg leading-relaxed">
            Tell us your interests and we&apos;ll recommend the perfect destination
            and itinerary for your dream African safari.
          </p>
          <Link
            href="/contact"
