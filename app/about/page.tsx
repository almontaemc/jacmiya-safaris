...
const values = [
  {
    icon: "🤝",
    title: "Integrity",
    body: "We operate with full transparency — no hidden fees, no surprise costs. What we quote is what you pay.",
  },
  {
    icon: "🌿",
    title: "Sustainability",
    body: "We partner with eco-conscious lodges and support local conservation programs to protect the wildlife we celebrate.",
  },
  {
    icon: "🦅",
    title: "Excellence",
    body: "From first enquiry to last goodbye, every touchpoint is crafted to exceed expectations.",
  },
  {
    icon: "❤️",
    title: "Passion",
    body: "We're not just selling tours — we're sharing a love for Africa that's been with us since day one.",
  },
];
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <p className="text-cream/70 text-lg max-w-xl mx-auto leading-relaxed">
            We are storytellers, conservationists, and passionate guides — united
            by one belief: Africa deserves to be experienced, not just seen.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 px-4 bg-cream">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-bark mt-2 mb-6 leading-tight">
              Born From a Love of the Wild
            </h2>
            <div className="space-y-4 text-earth leading-relaxed">
              <p>
                Jacmiya Safaris was founded in 2014 by Jacmiya Wambua, a Nairobi-born
                wildlife enthusiast who believed that every traveler deserved a deeply
                personal, expertly guided encounter with East Africa&apos;s natural world.
              </p>
              <p>
                What began as one vehicle and a notebook full of dream itineraries has
                grown into one of Kenya&apos;s most trusted safari operators — with a
                portfolio spanning 70+ destinations across Kenya, Tanzania, and Rwanda.
              </p>
              <p>
                We combine deep local knowledge with world-class hospitality. Every
                guide on our team is a trained naturalist and a genuine storyteller.
                We don&apos;t just show you the Big Five — we help you understand the
                ecosystems, the communities, and the conservation battles that shape
                the Africa you&apos;re visiting.
              </p>
            </div>
            <div className="mt-8 flex gap-4">
              <Link
                href="/tours"
                className="bg-savanna hover:bg-savanna-dark text-white font-semibold px-6 py-3 rounded-full text-sm transition-colors"
              >
                Browse Our Tours
              </Link>
              <Link
                href="/contact"
                className="border border-forest text-forest hover:bg-forest hover:text-cream font-semibold px-6 py-3 rounded-full text-sm transition-colors"
              >
                Talk to Us
              </Link>
            </div>
          ...
          <div className="relative">
            ...
            <img
              src="https://jacmiyasafaris.com/wp-content/uploads/2026/01/Tanzania-600x427.jpg"
              ...
              {milestones.map((m) => (
                <div key={m.year} className="flex gap-6 items-start pl-2">
                  <div className="relative flex-shrink-0">
                    <div className="w-10 h-10 rounded-full bg-savanna flex items-center justify-center text-white font-bold text-xs z-10 relative">
                      {m.year.slice(2)}
                    </div>
                  </div>
            ...
            {team.map((member) => (
              <div key={member.name} className="text-center">
                ...
                <img
                  src={member.image}
                  alt={member.name}
                  className="w-32 h-32 rounded-full object-cover mx-auto mb-4 border-4 border-sand shadow-md"
                />
                <h3 className="font-serif font-bold text-bark text-lg mb-0.5">{member.name}</h3>
                <div className="text-savanna text-xs font-semibold uppercase tracking-widest mb-3">
                  {member.role}
                </div>
      ...
      <section className="py-20 px-4 bg-forest text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-cream/60 mb-8 text-lg leading-relaxed">
            Get in touch and let&apos;s design your perfect East African adventure
            together.
          </p>
          <Link
            href="/contact"
            className="bg-savanna hover:bg-savanna-dark text-white font-semibold px-10 py-4 rounded-full text-lg transition-colors inline-block shadow-lg shadow-savanna/20"
          >
            Plan Your Safari
          </Link>
        </div>
